...
#if you would like to use or modify this script, please kindly cite the related publication:
#Wang Y, White MM, Kvist S, Moncalvo JM. 2016. Genome-wide survey of gut fungi (Harpellales) reveals the first horizontally 
#transferred ubiquitin gene from a mosquito host. Mol. Biol. Evol. doi:10.1093/molbev/msw126.
